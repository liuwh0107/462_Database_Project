...
<input type="submit" value="masterpiece_of_directors.php">
</form>
<form action="avg_rating_of_director.php" method="post">
<input type="submit" value="avg_rating_of_director.php">
</form>
<form action="both_sex_rating>9_TOP10.php" method="post">
<input type="submit" value="both_sex_rating>9_TOP10.php">
</form>
<form action="duration<120_TOP10.php" method="post">
<input type="submit" value="duration<120_TOP10.php">
</form>
<form action="female_male_favorite_genre.php" method="post">
<input type="submit" value="female_male_favorite_genre.php">
</form>
<form action="most_genre_oscar.php" method="post">
<input type="submit" value="most_genre_oscar.php">
</form>
<form action="favorite_genre.php" method="post">
<input type="submit" value="favorite_genre.php">
</form>
</form>
<form action="most_genre_gloden_globe.php" method="post">
<input type="submit" value="most_genre_gloden_globe.php">
</form>
<form action="ten_years_BEST_PICTURE.php" method="post">
<input type="submit" value="ten_years_BEST_PICTURE.php">
</form>
<form action="most_win_director.php" method="post">
<input type="submit" value="most_win_director.php">
</form>
<form action="most_produce_ten_years.php" method="post">
<input type="submit" value="most_produce_ten_years.php">
</form>
<form action="most_prolific_genre.php" method="post">
<input type="submit" value="most_prolific_genre.php">
</form>
<form action="biggest_winner_golden_globe.php" method="post">
<input type="submit" value="biggest_winner_golden_globe.php">
</form>
<form action="Most_movie_of_each_country.php" method="post">
<input type="submit" value="Most_movie_of_each_country.php">
</form>
<form action="The_country_producing_best_movie.php" method="post">
<input type="submit" value="The_country_producing_best_movie.php">
</form>
<form action="Top_5_years_having_the_best_quality_of_movies.php" method="post">
<input type="submit" value="Top_5_years_having_the_best_quality_of_movies.php">
</form>
<form action="Top_100_movies_of_age.php" method="post">
<input type="submit" value="Top_100_movies_of_age.php">
</form>
