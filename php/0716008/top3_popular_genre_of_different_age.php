...
while ($actor = $result->fetch_assoc()) {    
  ...
  echo "<pre>"; 
  echo "{$actor['genre']}&nbsp{$actor['avg_rating_0_18']}";
  echo "</pre>";
}
...
while ($actor = $result->fetch_assoc()) {    
  ...
  echo "<pre>"; 
  echo "{$actor['genre']}&nbsp{$actor['avg_rating_18_30']}";
  echo "</pre>";
}
...
while ($actor = $result->fetch_assoc()) {    
  ...
  echo "<pre>"; 
  echo "{$actor['genre']}&nbsp{$actor['avg_rating_30_45']}";
  echo "</pre>";
}
...
while ($actor = $result->fetch_assoc()) {    
  ...
  echo "<pre>"; 
  echo "{$actor['genre']}&nbsp{$actor['avg_rating_45up']}";
  echo "</pre>";
}
